...
export const AddToBlocklist = async (data) => {
    try {
        ...
        const response = await BloackPageService.post(`https://user.dpacks.net/api/pros/Access/BlockList`, data);
...
export const getWebPages = async (count, page, key, val) => {
    try {
        const response = await BloackPageService.get(`https://user.dpacks.net/api/pros/Access/BlockLists/${count}/${page}?key=${key}&val=${val}`);
        return response.data;
    } catch (error) {
        throw error;
    }
...
export const getWebPagesCount = async (key, val,userId) => {
    try {
        const response = await BloackPageService.get(`https://user.dpacks.net/api/pros/Access/BlockList/count?key=${key}&val=${val}`);
        return response.data;
    } catch (error) {
        throw error;
    }
...
export const getPagesByStatus = async (count, page, status, key, val) => {
    ...
    try {
        const response = await BloackPageService.get(`https://user.dpacks.net/api/pros/Access/BlockList/status/${count}/${page}?status=${statusString}&key=${key}&val=${val}`);
...
export const getPagesByStatusCount = async (status, key, val) => {
    ...
    try {
        const response = await BloackPageService.get(`https://user.dpacks.net/api/pros/Access/BlockList/status/count?status=${statusString}&key=${key}&val=${val}`);
        console.log(response.data);
        return response.data;
    } catch (error) {
        throw error;
...
export const updateWebpagesStatusBulk = async (ids, status) => {
    ...
    try {
        const response = await BloackPageService.put(`https://user.dpacks.net/api/pros/Access/BlockList/status/bulk/${idsString}`, {status: status});
        return response.data;
    } catch (error) {
        throw error;
    }
...
export const updateWebpagesStatus = async (id, status) => {
    try {
        const response = await BloackPageService.put(`https://user.dpacks.net/api/pros/Access/BlockList/status/${id}`, {status: status});
        return response.data;
    } catch (error) {
        throw error;
    }
