...
export const GetUserData = async () => {
    try {
        const response = await UserProfileService.get(`http://localhost:4003/api/pros/Users/GetData`);
...
export const UpdateUser = async (data) => {
    try {
        console.log(data);
        const response = await UserProfileService.put(`http://localhost:4003/api/pros/Users/Update`,data);
        return response.data;
    } catch (error) {
        throw error;
    }
