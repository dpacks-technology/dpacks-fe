...
export const GetUserData = async () => {
    try {
        const response = await UserProfileService.get(`https://user.dpacks.net/api/pros/Users/GetData`);
...
export const UpdateUser = async (data) => {
    try {
        console.log(data);
        const response = await UserProfileService.put(`https://user.dpacks.net/api/pros/Users/Update`,data);
        return response.data;
    } catch (error) {
        throw error;
    }
