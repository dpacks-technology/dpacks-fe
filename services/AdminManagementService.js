...
//
//     try {
//         const response = await adminUserService.get(`/api/web/webpages/status/${count}/${page}?status=${statusString}&key=${key}&val=${val}`);
...
//
//     try {
//         const response = await adminUserService.get(`/api/web/webpages/status/count?status=${statusString}&key=${key}&val=${val}`);
//         console.log(response.data);
//         return response.data;
//     } catch (error) {
//         throw error;
...
//
//     try {
//         const response = await adminUserService.get(`/api/web/webpages/datetime/${count}/${page}?start=${start}&end=${end}&key=${key}&val=${val}`);
//         console.log(response.data);
//         return response.data;
//     } catch (error) {
//         throw error;
...
//     try {
//         const response = await adminUserService.get(`/api/web/webpages/datetime/count?start=${start}&end=${end}&key=${key}&val=${val}`);
//         console.log(response.data);
//         return response.data;
//     } catch (error) {
//         throw error;
...
export const editAdmin = async (id, data) => {
    try {
        const response = await adminUserService.put(`/api/admins/${id}`, data);
        return response.data;
    } catch (error) {
        throw error;
    }
...
export const getAdminById = async (id) => {
    try {
        const response = await adminUserService.get(`/api/admin_user/admins/${id}`);
        return response.data;
    } catch (error) {
        throw error;
    }
...
//
//     try {
//         const response = await adminUserService.delete(`/api/web/webpages/bulk/${idsString}`);
//         return response.data;
//     } catch (error) {
//         throw error;
//     }
...
//
//     try {
//         const response = await adminUserService.put(`/api/web/webpages/status/bulk/${idsString}`, {status: status});
//         return response.data;
//     } catch (error) {
//         throw error;
//     }
...
//     try {
//         const response = await adminUserService.put(`/api/web/webpages/status/${id}`, {status: status});
//         return response.data;
//     } catch (error) {
//         throw error;
//     }
...
//     try {
//         const response = await adminUserService.post(`/api/web/webpage`, data);
//         return response.data;
//     } catch (error) {
//         throw error;
//     }
